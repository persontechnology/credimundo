...
jQuery.validator.addMethod('nota', function(value, element, param) {
 ...
 jQuery.validator.addMethod('menor100', function(value, element, param) {
     return value<=100;
 },"El valor ingresado no puede ser mayor a 100");

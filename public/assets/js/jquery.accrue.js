...
;(function( $, window, document, undefined ){
    ...
    $.fn.accrue.options = {
        ...
        error_text: '<p class="error alert alert-danger">Por favor rellena todos los campos.</p>',
    ...
    var calculateAmortization = function( elem, options, output_elem ){
        ...
        if ( loan_info!==0 ) {
            ...
            var output_content = '<table class="accrue-amortization table table-bordered">'+
                    '<thead><tr>'+
                    '<th class="accrue-payment-number">#</th>'+
                    '<th class="accrue-payment-amount">Monto de pago</th>'+
